...
export const ExploreView: React.FC<ExploreViewProps> = ({ currentUser }) => {
    ...
    return (
        <div className="w-full flex-grow flex flex-col lg:flex-row gap-4 animate-pop-in min-h-0">
            ...
            <div className="w-full lg:w-2/3 xl:w-3/4 flex flex-col gap-4">
                <div className="flex-grow rounded-2xl shadow-lg border relative min-h-[300px] sm:min-h-[400px] lg:min-h-0" style={{ backgroundColor: 'var(--panel-bg)', borderColor: 'var(--border-primary)' }}>
                    ...
                    <button 
                        ...
                        className="absolute top-3 left-3 flex items-center gap-2 bg-slate-700/50 hover:bg-slate-600/70 text-white font-bold py-2 px-4 rounded-lg shadow-md transform hover:scale-105 transition-all"
                    >
            ...
            {/* Right Panel: Controls & Calculation */}
