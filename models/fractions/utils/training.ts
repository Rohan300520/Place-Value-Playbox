...
export const fractionTrainingPlan: FractionTrainingStep[] = [
  ...
  {
    module: 4, step: 29, type: 'action', text: "Finally, let's try subtraction.", requiredAction: 'continue', spotlightOn: 'continue_button', clearWorkspaceAfter: true,
  },
  {
  ...
  },
  {
    ...
    text: "Now, watch as we take away one of those 1/4 pieces.",
    animation: 'remove',
  ...
  // --- Completion ---
  {
    module: 5, step: 33, type: 'complete',
