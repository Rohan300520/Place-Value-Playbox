...
export const fractionTrainingPlan: FractionTrainingStep[] = [
  ...
  },
  {
    ...
    type: 'feedback',
    ui: 'operations',
    text: "To subtract, the 1/2 bar changes into two 1/4 bars. Now the pieces are the same size!",
    duration: 5000,
  },
  {
    step: 27,
    type: 'feedback',
    ui: 'operations',
    text: "Two fourths minus one fourth leaves one fourth. The answer is 1/4!",
    duration: 5000,
    clearBoardAfter: true,
  },
