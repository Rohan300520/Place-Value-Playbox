                ...
                <div className="w-full">
                    {equation.isSolved ? (
                        ...
                        <div className="w-full flex flex-col items-center animate-pop-in">
                            ...
                            {/* Fix: Pass the required 'isCombining' boolean argument. Result pieces are not combining. */}
                            {renderPieceGroup(equation.resultPieces, false)}
                        </div>
                    ) : (
                        // BUILDING VIEW: Show the terms horizontally.
                        <div className="flex flex-wrap items-center gap-4">
                            {/* Fix: Calculate 'isCombining' and pass all required arguments to renderPieceGroup. */}
