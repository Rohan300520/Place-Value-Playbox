...
const ShapeCard: React.FC<{
    ...
    return (
        <button
            onClick={onClick}
            className="group w-full p-6 rounded-2xl shadow-lg border text-center transition-all duration-300 transform hover:-translate-y-2"
...
export const ShapeSelector: React.FC<ShapeSelectorProps> = ({ onSelect, shapes }) => {
    return (
