...
export const HelpModal: React.FC<HelpModalProps> = ({ onClose }) => {
  return (
    ...
    >
      <div 
        className="bg-sky-50 rounded-2xl shadow-2xl p-6 sm:p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-pop-in"
        onClick={(e) => e.stopPropagation()} // Prevent closing modal when clicking inside
      >
        <div className="flex justify-between items-center mb-4">
          <h2 id="help-modal-title" className="text-3xl sm:text-4xl font-black text-blue-800">How to Play</h2>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6 text-slate-700 text-lg">
          <section>
            <h3 className="text-2xl font-bold text-emerald-700 mb-2">The Goal</h3>
          ...
          <section>
            <h3 className="text-2xl font-bold text-emerald-700 mb-2">Game Modes</h3>
            <ul className="list-disc list-inside space-y-2">
              ...
              <li><strong className="text-emerald-600">Playground:</strong> A free-play area to explore and build any number you can imagine. There are no rules here!</li>
          ...
          <section>
            <h3 className="text-2xl font-bold text-emerald-700 mb-2">How It Works</h3>
            <ul className="list-disc list-inside space-y-2">
          ...
          <section>
            <h3 id="about-section-title" className="text-3xl font-black text-blue-800 mb-2">About</h3>
