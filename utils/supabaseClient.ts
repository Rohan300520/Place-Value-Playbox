// Fix: Added a triple-slash directive to include Vite's client types, which provides type definitions for `import.meta.env` and resolves the TypeScript errors.
